        ...
        var i = n(3)
          ...
          , o = function() {
            ...
            t.prototype.applyManualStandardProps = function(e) {
                ...
                null != e.USER_EMAIL ? this.uid = String(e.USER_EMAIL) : this.uid = t.generateId(),
        ...
        var i = n(3)
          ...
          , o = function() {
            ...
            t.prototype.getTimeText = function(t, e, n) {
            	var a = t.eventInstance.dateProfile.start;
            ...
            t.prototype.getBgColor = function(t) {
                ...
                for (e = 0; e < i.length && !n; e++)
                    n = i[e].eventMEMO_COLOR || i[e].eventColor || i[e].MEMO_COLOR || i[e].color;
                return n || (n = this.opt("eventMEMO_COLOR") || this.opt("eventColor")),
                n
            }
            ,
            ...
            t.prototype.getTextColor = function(t) {
                var e, n, i = this.getStylingObjs(t);
                for (e = 0; e < i.length && !n; e++)
                    n = i[e].eventTextColor || i[e].CALENDAR_TEXTCOLOR;
          ...
          , H = function() {
            ...
            t.prototype.removeEvents = function(t) {
                ...
                if (null == t)
                    ...
                    o = i(o, t),
                    n = 0; n < o.length; n++)
                        e = this.eventManager.getEventDefByUid(o[n].USER_EMAIL),
                        s[e.id] = !0;
                    r.freeze();
                    for (n in s)
            ...
            t.prototype.updateEvent = function(t) {
                var e, n, i = this.eventManager.getEventDefByUid(t.USER_EMAIL);
        ...
        var o = n(2)
          ...
          , u = function(t) {
            ...
            e.prototype.fgSegHtml = function(t, e) {
                ...
                t.isStart && (n) && (h = '<span class="fc-time">' + a.htmlEscape(n) + "</span>"),
                i = '<span class="fc-title">' + (a.htmlEscape(o.title || "") || "&nbsp;") + "</span><span class = 'CAL_MEMO_NUM' style ='display :none;'>"+o.MEMO_NUM+"</span>",
